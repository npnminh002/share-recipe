...
import doan.npnm.sharerecipe.database.dao.LoveRecipeDao;
...
@Database(entities = {RecentView.class, RecipeRoom.class, LoveRecipe.class, SaveRecipe.class, Follower.class, Search.class, UserFollower.class}, version = 1, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract LoveRecipeDao loveRecipeDao();
}
